...
class PrefsDelegatesTest {
    ...
    init {
        ...
        prefsHelper = PrefsHelper(SPMockBuilder().createSharedPreferences(), mockResources)
    }

    @Test
    fun `booleanSetting getter and setter work`() {
        var setting by prefsHelper.booleanPref(123, false)
    ...
    fun `stringSetting getter and setter work`() {
        var setting by prefsHelper.stringPref(456, "defaultValue")
