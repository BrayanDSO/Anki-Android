...
class SyncSettingsFragment : SettingsFragment() {
    ...
    override fun initSubscreen() {
        ...
        setFragmentResultListener(HAS_LOGIN_STATUS_CHANGED_KEY) { _, bundle ->
            if (bundle.getBoolean(HAS_LOGIN_STATUS_CHANGED_KEY, false)) {
    ...
    companion object {
        const val HAS_LOGIN_STATUS_CHANGED_KEY = "login_status_changed"
    }
}
