...
object GestureParser {
    ...
    fun parse(
        ...
        return if (gestureMode == TapGestureMode.FOUR_POINT) {
            getFourPointsTap(tapX, tapY, scrollX, scrollY, measuredWidth, measuredHeight, scale)
        } else {
            getNinePointsTap(tapX, tapY, scrollX, scrollY, measuredWidth, measuredHeight, scale)
        }
    }
