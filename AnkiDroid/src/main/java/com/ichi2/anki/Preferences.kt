...
class Preferences : AnkiActivity() {
    ...
    class GeneralSettingsFragment : SettingsFragment() {
        ...
        override fun initSubscreen() {
            ...
            requirePreference<SwitchPreference>(R.string.paste_png_key).apply {
                ...
                setOnPreferenceChangeListener { _, newValue ->
                    col.set_config("pastePND", newValue)
                    true
                }
            }
        ...
        private fun initializeLanguageDialog() {
            ...
            languageSelection.setOnPreferenceClickListener {
    ...
    class ReviewingSettingsFragment : SettingsFragment() {
        ...
        override fun initSubscreen() {
            ...
            requirePreference<SwitchPreference>(R.string.new_timezone_handling_preference).apply {
                isChecked = if (col.schedVer() <= 1) {
                    false
                } else {
                    col.sched._new_timezone_enabled()
                }
                setOnPreferenceChangeListener { _, newValue ->
                    if (newValue == true) {
                        try {
    ...
    class AdvancedSettingsFragment : SettingsFragment() {
        ...
        override fun initSubscreen() {
            ...
            requirePreference<SwitchPreference>(R.string.card_browser_external_context_menu_key).setOnPreferenceChangeListener { _, newValue ->
            ...
            requirePreference<SwitchPreference>(R.string.anki_card_external_context_menu_key).setOnPreferenceChangeListener { _, newValue ->
